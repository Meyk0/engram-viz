---
title: "Mem0 adapter"
description: "Instrument Mem0 operations while preserving the distinction between retrieval and active context."
icon: "database"
---
...
See the [stale-location example](/examples/stale-location) for the deterministic reference incident.
